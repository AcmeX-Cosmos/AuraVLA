...
GRIPPER_CONTACT_OFFSET = float(
    os.environ.get("AURA_GRIPPER_CONTACT_OFFSET", "0.0005")
)
GRIPPER_REST_OFFSET = float(
    os.environ.get("AURA_GRIPPER_REST_OFFSET", "0.0")
)
PRECISION_OBJECT_CONTACT_OFFSET = float(
    os.environ.get("AURA_PRECISION_OBJECT_CONTACT_OFFSET", "0.0005")
)
PRECISION_OBJECT_REST_OFFSET = float(
    os.environ.get("AURA_PRECISION_OBJECT_REST_OFFSET", "0.0")
)
