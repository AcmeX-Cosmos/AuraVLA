...
def _load_aura_runtime_config() -> None:
    ...
    config_env = {
        ...
        "AURA_GRASP_MIN_SHORT_AXIS_ALIGNMENT": (
            "grasp_min_short_axis_alignment",
            0.92,
        ),
        ...
        "AURA_GRASP_APERTURE_MARGIN": ("grasp_aperture_margin_m", 0.0005),
        "AURA_GRASP_PLANAR_REFINEMENT_STEPS": (
            "grasp_planar_refinement_steps",
            2,
        ),
        "AURA_GRASP_PLANAR_CENTER_TOLERANCE": (
            "grasp_planar_center_tolerance_m",
            0.003,
        ),
        "AURA_GRASP_MAX_PLANAR_CORRECTION": (
            "grasp_max_planar_correction_m",
            0.015,
        ),
        "AURA_GRASP_APPROACH_ORIENTATION_KEYFRAMES": (
            "grasp_approach_orientation_keyframes",
            10,
        ),
        "AURA_GRASP_CONTACT_CONFIRMATION_MARGIN": (
            "grasp_contact_confirmation_margin_m",
            0.0005,
        ),
        "AURA_GRASP_MINIMUM_PHYSICAL_OPENING_MARGIN": (
            "grasp_minimum_physical_opening_margin_m",
            0.0005,
        ),
        "AURA_GRASP_LOW_POSE_CORRECTION_LIMIT": (
            "grasp_low_pose_correction_limit_m",
            0.015,
        ),
        ...
        "AURA_VERBOSE_MOTION_LOG": ("verbose_motion_log", False),
        ...
        "AURA_GRASP_APPROACH_MAX_STEP_DELTA": ("grasp_approach_max_step_delta_rad", 0.0015),
        "AURA_GRASP_APPROACH_CARTESIAN_WAYPOINTS": ("grasp_approach_cartesian_waypoints", 2),
        "AURA_GRASP_LIFT_MAX_JOINT_STEP": ("grasp_lift_max_joint_step_rad", 0.03),
        "AURA_GRASP_LIFT_MIN_FRAMES": ("grasp_lift_min_frames", 20),
        "AURA_GRASP_LIFT_MAX_STEP_DELTA": ("grasp_lift_max_step_delta_rad", 0.0012),
        "AURA_GRASP_LIFT_SETTLE_FRAMES": ("grasp_lift_settle_frames", 12),
        "AURA_GRIPPER_MAX_COMMAND_STEP_M": ("gripper_max_command_step_m", 0.001),
        "AURA_GRIPPER_MAX_COMMAND_STEP_DELTA_M": ("gripper_max_command_step_delta_m", 0.00025),
